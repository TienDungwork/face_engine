...
async def compare_face(request: FaceCompareRequest) -> FaceCompareResponse:
    ...
    Args:
        request (FaceDetectRequest): Request containing base64 images only
    ...
    try:
        ...
        image_1 = await _get_valid_image(request.base64_1)
        image_2 = await _get_valid_image(request.base64_2)
...
async def _get_valid_image(base64_image: str):
